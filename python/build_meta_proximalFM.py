...
if __name__ == "__main__":
    ...
    ##################### Week 3 #############################
    ## data
    train_reader = DataReader(train_config['data_dictionary'])
    ...
    ftrlfm = ProximalFM(train_config['model'])

    stacker = BinaryStackingClassifierNP([ftrlfm], xfolds=xfolds, evaluation=auc)
